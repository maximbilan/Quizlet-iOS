...
{
    [self.sets viewSetsByIds:setIds withAuth:self.auth success:success failure:failure];
}
...
{
    [self.sets editTerm:dictionary fromSetById:setId byTermId:termId withAuth:self.auth success:success failure:failure];
}
